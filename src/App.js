              ...
              <Droppable droppableId={col} key={col}>
                {(provided)=>(
                  <div
                    ...
                    style={{
                      ...styles.column,
                      background: col==="TODO" ? "#f84e9e" : col==="DOING" ? "#FFD93D" : "#77ff89"
                    }}
                  >
...
const styles = {
  ...
  overlay:{
    ...
    width:"100%",
    height:"100%",
    background:"rgba(158, 168, 255, 0.53)",
    top:0,
    left:0,
  },
  ...
  welcome:{textAlign:"center",color:"#380101"},
  ...
  addBtn:{padding:"10px",background:"#ff7817",border:"none"},
